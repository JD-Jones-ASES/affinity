...
ADR-0038) + 8 formula-sheet entries (dimensional homogeneity machine-checked, ADR-0039), 255 producer tests +
7 Node gates + `astro build` (21 pages) + live CI/Pages green. Lesson practice mass/leftover questions are
