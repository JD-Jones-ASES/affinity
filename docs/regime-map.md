...
| gases (ideal-gas model) | 1, 2 | **2** | **gym + atlas** (`gas_laws_v1` gym: PV=nRT + combined gas law, solve for any variable, model-exact-then-rounded, model-assumed badge — ADR-0040; formula sheet: ideal gas law + combined gas law, dimensional homogeneity machine-checked — ADR-0039). A gas-stoichiometry lesson is the next Phase-2 increment |
